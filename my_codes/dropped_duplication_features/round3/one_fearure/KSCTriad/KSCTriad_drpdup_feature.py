...
# ------------ input files -------------
KSCTriad_90 = '../../../../normalized_features/round3/one_fearure/KSCTriad/KSCTriad_90_mixed_normalized.tsv'
KSCTriad_80 = '../../../../normalized_features/round3/one_fearure/KSCTriad/KSCTriad_80_mixed_normalized.tsv'
# ------------ output files -------------
dropdup_90 = 'KSCTriad_90_mixed_dropdup.tsv'
dropdup_80 = 'KSCTriad_80_mixed_dropdup.tsv'
# ---------------------------------------
# drop dups cdhit 90 data
KSCTriad_90_df = get_data_frame_from_tsv_file(KSCTriad_90)
print("before drop 90 cdhit, shape= ", KSCTriad_90_df.shape)
print(KSCTriad_90_df)

dups = dropdup.find_duplicated_columns(KSCTriad_90_df)
df90 = KSCTriad_90_df.drop(dups, axis=1)
...
print("before drop 80 cdhit, shape= ", KSCTriad_80_df.shape)
print(KSCTriad_80_df)

dups = dropdup.find_duplicated_columns(KSCTriad_80_df)
df80 = KSCTriad_80_df.drop(dups, axis=1)
print("duplicate cols", dups)
