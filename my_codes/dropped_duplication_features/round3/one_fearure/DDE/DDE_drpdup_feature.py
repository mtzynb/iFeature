...
# ------------ input files -------------
DDE_90 = '../../../../normalized_features/round3/one_fearure/DDE/DDE_90_mixed_normalized.tsv'
DDE_80 = '../../../../normalized_features/round3/one_fearure/DDE/DDE_80_mixed_normalized.tsv'
# ------------ output files -------------
dropdup_90 = 'DDE_90_mixed_dropdup.tsv'
dropdup_80 = 'DDE_80_mixed_dropdup.tsv'
# ---------------------------------------
# drop dups cdhit 90 data
DDE_90_df = get_data_frame_from_tsv_file(DDE_90)
print("before drop 90 cdhit, shape= ", DDE_90_df.shape)
print(DDE_90_df)

dups = dropdup.find_duplicated_columns(DDE_90_df)
df90 = DDE_90_df.drop(dups, axis=1)
...
print("before drop 80 cdhit, shape= ", DDE_80_df.shape)
print(DDE_80_df)

dups = dropdup.find_duplicated_columns(DDE_80_df)
df80 = DDE_80_df.drop(dups, axis=1)
print("duplicate cols", dups)
