...
combineCTD_train_100 = '../../../../normalized_features/one_fearure/CTD/combine/combineCTD_100_mixed_train_normalized.tsv'
combineCTD_train_90 = '../../../../normalized_features/one_fearure/CTD/combine/combineCTD_90_mixed_train_normalized.tsv'
combineCTD_train_80 = '../../../../normalized_features/one_fearure/CTD/combine/combineCTD_80_mixed_train_normalized.tsv'

# ------------ output files -------------
dropdup_train_100 = 'combineCTD_100_mixed_train_dropdup.tsv'
dropdup_train_90 = 'combineCTD_90_mixed_train_dropdup.tsv'
dropdup_train_80 = 'combineCTD_80_mixed_train_dropdup.tsv'
# ---------------------------------------
# drop dups cdhit 100 train data
combineCTD_train_100_df = get_data_frame_from_tsv_file(combineCTD_train_100)
print("before drop 100 cdhit, shape= ", combineCTD_train_100_df.shape)
print(combineCTD_train_100_df)

dups = dropdup.find_duplicated_columns(combineCTD_train_100_df)
df100 = combineCTD_train_100_df.drop(dups, axis=1)
...
print("before drop 90 cdhit, shape= ", combineCTD_train_90_df.shape)
print(combineCTD_train_90_df)

dups = dropdup.find_duplicated_columns(combineCTD_train_90_df)
df90 = combineCTD_train_90_df.drop(dups, axis=1)
print("duplicate cols", dups)
...
print("before drop 80 cdhit, shape= ", combineCTD_train_80_df.shape)
print(combineCTD_train_80_df)

dups = dropdup.find_duplicated_columns(combineCTD_train_80_df)
df80 = combineCTD_train_80_df.drop(dups, axis=1)
print("duplicate cols", dups)
