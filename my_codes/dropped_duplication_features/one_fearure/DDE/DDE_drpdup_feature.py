...
DDE_train_100 = '../../../normalized_features/one_fearure/DDE/DDE_100_mixed_train_normalized.tsv'
DDE_train_90 = '../../../normalized_features/one_fearure/DDE/DDE_90_mixed_train_normalized.tsv'
DDE_train_80 = '../../../normalized_features/one_fearure/DDE/DDE_80_mixed_train_normalized.tsv'

# ------------ output files -------------
dropdup_train_100 = 'DDE_100_mixed_train_dropdup.tsv'
dropdup_train_90 = 'DDE_90_mixed_train_dropdup.tsv'
dropdup_train_80 = 'DDE_80_mixed_train_dropdup.tsv'
# ---------------------------------------
# drop dups cdhit 100 train data
DDE_train_100_df = get_data_frame_from_tsv_file(DDE_train_100)
print("before drop 100 cdhit, shape= ", DDE_train_100_df.shape)
print(DDE_train_100_df)

dups = dropdup.find_duplicated_columns(DDE_train_100_df)
df100 = DDE_train_100_df.drop(dups, axis=1)
...
print("before drop 90 cdhit, shape= ", DDE_train_90_df.shape)
print(DDE_train_90_df)

dups = dropdup.find_duplicated_columns(DDE_train_90_df)
df90 = DDE_train_90_df.drop(dups, axis=1)
print("duplicate cols", dups)
...
print("before drop 80 cdhit, shape= ", DDE_train_80_df.shape)
print(DDE_train_80_df)

dups = dropdup.find_duplicated_columns(DDE_train_80_df)
df80 = DDE_train_80_df.drop(dups, axis=1)
print("duplicate cols", dups)
