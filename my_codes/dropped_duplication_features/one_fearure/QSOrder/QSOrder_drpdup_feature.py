...
QSOrder_train_100 = '../../../normalized_features/one_fearure/QSOrder/QSOrder_100_mixed_train_normalized.tsv'
QSOrder_train_90 = '../../../normalized_features/one_fearure/QSOrder/QSOrder_90_mixed_train_normalized.tsv'
QSOrder_train_80 = '../../../normalized_features/one_fearure/QSOrder/QSOrder_80_mixed_train_normalized.tsv'

# ------------ output files -------------
dropdup_train_100 = 'QSOrder_100_mixed_train_dropdup.tsv'
dropdup_train_90 = 'QSOrder_90_mixed_train_dropdup.tsv'
dropdup_train_80 = 'QSOrder_80_mixed_train_dropdup.tsv'
# ---------------------------------------
# drop dups cdhit 100 train data
QSOrder_train_100_df = get_data_frame_from_tsv_file(QSOrder_train_100)
print("before drop 100 cdhit, shape= ", QSOrder_train_100_df.shape)
print(QSOrder_train_100_df)

dups = dropdup.find_duplicated_columns(QSOrder_train_100_df)
df100 = QSOrder_train_100_df.drop(dups, axis=1)
...
print("before drop 90 cdhit, shape= ", QSOrder_train_90_df.shape)
print(QSOrder_train_90_df)

dups = dropdup.find_duplicated_columns(QSOrder_train_90_df)
df90 = QSOrder_train_90_df.drop(dups, axis=1)
print("duplicate cols", dups)
...
print("before drop 80 cdhit, shape= ", QSOrder_train_80_df.shape)
print(QSOrder_train_80_df)

dups = dropdup.find_duplicated_columns(QSOrder_train_80_df)
df80 = QSOrder_train_80_df.drop(dups, axis=1)
print("duplicate cols", dups)
